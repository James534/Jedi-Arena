    ...
    void Update ()
    {
        ...
        if (updateReference) {
            ...
            _antiYaw = Quaternion.FromToRotation (
                new Vector3 (myo.transform.forward.x, 0, myo.transform.forward.z), //myo.transform.forward.x
                new Vector3 (0, 0, 1)
            );
        ...
        if (thalmicMyo.xDirection == Thalmic.Myo.XDirection.TowardWrist) {
            ...
            transform.rotation = new Quaternion(transform.localRotation.x, -transform.localRotation.y,
